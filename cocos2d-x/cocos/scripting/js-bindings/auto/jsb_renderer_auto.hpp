...
SE_DECLARE_FUNC(js_renderer_NodeProxy_setGlobalZOrder);
SE_DECLARE_FUNC(js_renderer_NodeProxy_setIsGroup);
SE_DECLARE_FUNC(js_renderer_NodeProxy_setGroupDirty);
