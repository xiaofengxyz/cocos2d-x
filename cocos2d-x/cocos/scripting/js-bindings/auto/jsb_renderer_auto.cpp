...
static bool js_renderer_NodeProxy_setGlobalZOrder(se::State& s)
{
    cocos2d::renderer::NodeProxy* cobj = (cocos2d::renderer::NodeProxy*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_renderer_NodeProxy_setGlobalZOrder : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        ...
        SE_PRECONDITION2(ok, false, "js_renderer_NodeProxy_setGlobalZOrder : Error processing arguments");
...
SE_BIND_FUNC(js_renderer_NodeProxy_setGlobalZOrder)

static bool js_renderer_NodeProxy_setIsGroup(se::State& s)
{
    cocos2d::renderer::NodeProxy* cobj = (cocos2d::renderer::NodeProxy*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_renderer_NodeProxy_setIsGroup : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        bool arg0;
        ok &= seval_to_boolean(args[0], &arg0);
        SE_PRECONDITION2(ok, false, "js_renderer_NodeProxy_setIsGroup : Error processing arguments");
        cobj->setIsGroup(arg0);
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 1);
    return false;
}
SE_BIND_FUNC(js_renderer_NodeProxy_setIsGroup)

static bool js_renderer_NodeProxy_setGroupDirty(se::State& s)
{
    cocos2d::renderer::NodeProxy* cobj = (cocos2d::renderer::NodeProxy*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_renderer_NodeProxy_setGroupDirty : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        bool arg0;
        ok &= seval_to_boolean(args[0], &arg0);
        SE_PRECONDITION2(ok, false, "js_renderer_NodeProxy_setGroupDirty : Error processing arguments");
        cobj->setGlobalDirty(arg0);
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 1);
    return false;
}
SE_BIND_FUNC(js_renderer_NodeProxy_setGroupDirty)
...
bool js_register_renderer_NodeProxy(se::Object* obj)
{
    ...
    cls->defineFunction("setGlobalZOrder", _SE(js_renderer_NodeProxy_setGlobalZOrder));
    cls->defineFunction("setIsGroup", _SE(js_renderer_NodeProxy_setIsGroup));
    cls->defineFunction("setGroupDirty", _SE(js_renderer_NodeProxy_setGroupDirty));
